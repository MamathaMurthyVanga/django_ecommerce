...
def category(request, foo):
      ...
      try:
            ...
            messages.success(request,("That category does not exists"))
            return redirect("home")
...
#                         return redirect('home')
#                 else:
#                         messages.success(request,("oops! There was an error in registering. Try again"))
...
def register_user(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, "Oops! There was an error in registering. Please check the errors below.")
            return render(request, 'register.html', {'form': form})  # Keep the form with errors
